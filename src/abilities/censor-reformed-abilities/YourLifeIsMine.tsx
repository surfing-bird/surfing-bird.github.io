...
export const YourLifeIsMine = () => (
  <Ability
    ...
    effect="You can shift up to a number of squares equal to your Presence score. If you end this shift adjacent to the triggering creature, you may make a melee free strike against it. The triggering creature is considered judged by you until your use this ability again. Resolve this effect before the triggering creature's main action is resolved."
    spend={
      <Text>
