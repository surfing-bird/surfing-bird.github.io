...
const storyText = "leading-tight";

const Intro = () => (
  <PagePDF id="level-1">
    <div className="flex flex-col gap-2 m-auto w-[400px] p-3 border-1 rounded-sm border-gray-400 bg-[#F7F2EE]">
      <Heading2 className="text-center">An Ending</Heading2>
      <div className="flex flex-col gap-2">
        ...
        <Text className={storyText}>
          He too was having difficulty speaking, though for entirely different
          reasons.
        </Text>
        <Text className={storyText}>
        ...
        <Text className={storyText}>This was justice. It had to be.</Text>
        <Text className={storyText}>
        ...
        <Text className={storyText}>No response came.</Text>
        <Text className={storyText}>
        ...
        <Text className={storyText}>Alone again. Another ending.</Text>
        <Text className={storyText}>
